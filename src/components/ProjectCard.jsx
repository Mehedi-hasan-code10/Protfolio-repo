...
const ProjectCard = ({ image, title, description, link }) => (
  <motion.div
    ...
    className="relative bg-white/10 dark:bg-white/5 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden group hover:shadow-pink-500/40 transition-all duration-300"
  >
    ...
    <div className="p-6 text-center relative z-10">
      <h3 className="text-2xl font-extrabold bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400 bg-clip-text text-transparent mb-3 animate-text-shimmer">
        {title}
      </h3>
      ...
      <motion.a
        ...
        whileHover={{
          ...
          boxShadow: "0 0 25px rgba(236,72,153,0.5), 0 0 15px rgba(139,92,246,0.4)",
        }}
        whileTap={{ scale: 0.95 }}
